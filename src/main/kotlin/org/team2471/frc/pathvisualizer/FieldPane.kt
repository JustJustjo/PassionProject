...
//    private val canvas = Vbox()
//    private val arbitraryCanvas = Vbox()
//    private val replayCanvas = Vbox()
    ...
    private fun initConnectionStatusCheck() {
        ...
        timer.schedule(object : TimerTask() {
            override fun run() {
                ...
                if (InetAddress.getLocalHost().hostAddress.startsWith(
                        ControlPanel.ipAddress.substringBeforeLast(
                            ".",
                            "____"
                        )
                    )
